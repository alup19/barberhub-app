    ...
    <SafeAreaView className="flex-1 bg-bg bg-[#110F0E]">
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        <View className="px-6 pt-14">
          ...
          <Text className="text-text-muted text-white text-4xl mt-6">Criar conta</Text>
          <Text className="text-text-muted text-[#988C81] text-sm mt-2">Preencha seus dados para começar</Text>
          ...
          <View className="mt-6">
            <GoldButton label="Criar conta" onPress={() => router.replace("/home")} />
          </View>
